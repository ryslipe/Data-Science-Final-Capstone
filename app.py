...
if selected == 'Quarterbacks':    
   ...
   # enter a player name to display predictions
    ...
    def full_graph(player, master_set):
        ...
        fig.add_scatter(x = actual['period'], y = y_vals, mode = 'lines', markers = True, name ='Actual Points',
                       line = dict(color = 'black'))
    
        # Plot testing data (years) as a red line
        test_projections = actual['predicted']
        fig.add_scatter(x = actual['period'], y = test_projections, mode = 'lines', markers = True, name ='Predicted Points',
                       line = dict(color = 'red'))
